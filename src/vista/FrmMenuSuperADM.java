...
public class FrmMenuSuperADM extends javax.swing.JFrame {

    public static JDesktopPane jDesktopPane_menu;

    public FrmMenuSuperADM() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jMenuItem_GestionarDatos = new javax.swing.JMenuItem();
        ...
        jMenuItem_NuevoUsuario.setText("Nuevo Admin");
        ...
        jMenuItem_GestionarUsuario.setText("Gestionar Admins");
        ...
        jMenuItem_GestionarDatos.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jMenuItem_GestionarDatos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/configuraciones.png"))); // NOI18N
        jMenuItem_GestionarDatos.setText("Gestionar Datos");
        jMenuItem_GestionarDatos.setPreferredSize(new java.awt.Dimension(180, 30));
        jMenuItem_GestionarDatos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem_GestionarDatosActionPerformed(evt);
            }
        });
        jMenu1.add(jMenuItem_GestionarDatos);
    ...
    private void jMenuItem_GestionarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_GestionarUsuarioActionPerformed
        InterGestionarAdmins intercUsuario = new InterGestionarAdmins();
    ...
    private void jMenuItem_NuevoUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_NuevoUsuarioActionPerformed
        InterAdmin interUsuario = new InterAdmin();
    ...
    private void jMenuItem_GestionarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_GestionarDatosActionPerformed
        InterDatos interDatos = new InterDatos();
        jDesktopPane_menu.add(interDatos);
        interDatos.setVisible(true);
    }//GEN-LAST:event_jMenuItem_GestionarDatosActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMenuSuperADM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMenuSuperADM().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenuItem jMenuItem_GestionarDatos;
